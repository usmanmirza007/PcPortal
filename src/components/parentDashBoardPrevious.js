...
import { View, Text, StyleSheet, FlatList, AsyncStorage, Alert, Dimensions, TouchableOpacity, ImageBackground } from 'react-native';
...
// create a component
export default class parentDashBoardPrevious extends Component {
    constructor(props) {
        super(props);
        this.state = {
            radio_props: [
    ...
    renderRow = ({ item }) => {
        ...
        return (
            <TouchableOpacity onPress={() => { this.props.navigation.navigate('taskShowDetailParent') }} style={{ height: 50, justifyContent: 'space-between', marginHorizontal: 25, borderRadius: 5, backgroundColor: '#651fff', marginTop: 15, flexDirection: 'row' }}>
                ...
                <ImageBackground source={require('./../images/bg2.png')} style={{ width: '100%', height: '100%', }}>
                    ...
                    <View style={{ height: '10%', backgroundColor: '#651fff', }}>
                        <View style={{ marginTop: 20, }}>
                            <Text style={{ fontSize: 15, alignSelf: 'center', color: '#fff' }}>Assign Tasks</Text>
                        </View>
                    </View>
                    <FlatList
