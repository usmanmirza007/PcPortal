...
// create a component
export default class taskDeatilChildren extends Component {
    constructor(props) {
        super(props);
        this.state = {
            radio_props: [
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <ImageBackground source={require('./../images/bg7.png')} style={{ width: '100%', height: '100%', }}>
                    ...
                    <ImageBackground source={require('./../images/DetailBox.png')} style={{ width: 100, height: 100 }}>
                        <Text>lshflsdj;l</Text>
                    </ImageBackground>
                </ImageBackground>
            </View>
        );
