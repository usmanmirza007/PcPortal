...
import { View, Text, StyleSheet, Image,AsyncStorage, Alert, TextInput,Dimensions,  TouchableOpacity, ImageBackground } from 'react-native';
...
// create a component
export default class childrenLogin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      radio_props: [
  ...
  onSignin(email, password) {
    ...
    if (this.state.email === '' || this.state.password === '') {
      ...
      axios.post(`https://pcportal.malangis.com/public/api/children_login`,
        {
          "email": email,
          "password": password
        }
  ...
  onLoginSuccess() {
    ...
    this.props.navigation.navigate('homeChildren')
  }
      ...
      <View style={{ flex: 1 }}>
        <ImageBackground source={require('./../images/bg3.png')} style={{ width: '100%', height: '100%', }}>
          <View style={{ flex: 4, alignItems: 'center', marginTop: '5%', justifyContent: 'center' }}>
            ...
            <Text style={{ color: '#fff', fontSize: 20, fontWeight: 'bold', marginBottom: 60 }}>Children Login</Text>
          </View>
...
*/}
            ...
            {this.renderButton()}
            <TouchableOpacity onPress={() => { this.props.navigation.navigate('signUpChildren') }} >
