    ...
    return (
      <View style={{ flex: 1, alignItems: 'center' }}>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('childrenLogin') }} style={{ width: width(40), justifyContent: 'center', alignItems: 'center', height: height(12), backgroundColor: '#f7f2f2', marginHorizontal: width(2), borderRadius: 5, elevation: 5 }}>
