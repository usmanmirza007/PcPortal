    ...
    return (
      <View style={{flex:1}}>
        <View style = {{flexDirection: 'row'}}>
          ...
          <View style = {{ borderBottomWidth: 2, borderBottomColor: '#EAEAEAEA', marginLeft: 30 }}>
            <TouchableOpacity onPress={()=>{this.props.navigation.navigate('parentDashboardAddTask')}} style={{marginLeft: 5, flexDirection:'row', marginVertical: height(2),}}>
            <Ionicons
              name='md-add-circle'
              type='font-awesome'
              color='#651fff'
            ...
            />
            <View style = {{marginLeft: 15, marginTop: 1, }}>
              <Text style={{ color:'black', fontSize: 13 }}>Add Task</Text>
            </View>
            </TouchableOpacity>
          </View>
          <View style = {{ borderBottomWidth: 2, borderBottomColor: '#EAEAEAEA', marginLeft: 30 }}>
            <TouchableOpacity onPress={()=>{this.props.navigation.navigate('parentDashBoardPrevious')}} style={{marginLeft: 5, flexDirection:'row', marginVertical: height(2),}}>
            <FontAwesome
              name='list'
              type='font-awesome'
              color='#651fff'
            ...
            />
            <View style = {{marginLeft: 15, marginTop: 1, }}>
              <Text style={{ color:'black', fontSize: 13 }}>assign Tasks</Text>
            </View>
            </TouchableOpacity>
          </View>
          <View style = {{ borderBottomWidth: 2, borderBottomColor: '#EAEAEAEA', marginLeft: 30 }}>
            <TouchableOpacity onPress={()=>{this.RemoveAsync()}} style={{marginLeft: 5, flexDirection:'row', marginVertical: height(2),}}>
            <Entypo
              name='log-out'
              type='font-awesome'
              color='#651fff'
